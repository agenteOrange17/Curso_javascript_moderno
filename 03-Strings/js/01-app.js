...
const producto2 = "Monitor 30 Pulgadas"; // Utiliza comillas o dobles

// pero nunca las mezcles

//const producto3 = "Monitor 20 Pulgadas'; //Esto dara un error

// Ejemplo con Pulgadas
const producto4 = "Monitor 24\""; //Escapar comillas
