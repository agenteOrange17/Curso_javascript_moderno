...
*/
// Si autetificado esta como true pero si no se cumpl, la linea despues de ":" pasa a ser evaluada
console.log( autenticado  ? 'Si esta autenticado' : 'No esta autenticado');


// El OR y el && también se pueden utilizar en el ternario

console.log( autenticado && puedePagar ? 'Si esta autenticado por segundo filtro' : 'No esta autenticado');
